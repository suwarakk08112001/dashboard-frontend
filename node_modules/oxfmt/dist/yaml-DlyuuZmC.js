...
__esmMin((() => {
	...
	vo = () => {}, dt = vo;
	gt = "string", yt = "array", Wt = "cursor", Xt = "indent", Ue = "align", zt = "trim", je = "group", Ve = "fill", Ge = "if-break", Zt = "indent-if-break", Qe = "line-suffix", en = "line-suffix-boundary", ke = "line", tn = "label", He = "break-parent", nn = /* @__PURE__ */ new Set([
		Wt,
		Xt,
		Ue,
		zt,
...
` || t === "\r" || t === "\u2028" || t === "\u2029";
	...
	Nt = (t) => t.position.start.offset, mr = (t) => t.position.end.offset;
	hr = "format";
	dr = /^\s*#[^\S\n]*@(?:noformat|noprettier)\s*?(?:\n|$)/, gr = /^\s*#[^\S\n]*@(?:format|prettier)\s*?(?:\n|$)/, yr = /^\s*@(?:format|prettier)\s*$/;
	wr = (t) => yr.test(t), br = (t) => gr.test(t), kr = (t) => dr.test(t), Sr = (t) => `# @${hr}
...
${t}`;
	...
	wn = Symbol.for("yaml.alias"), bn = Symbol.for("yaml.document"), oe = Symbol.for("yaml.map"), bs = Symbol.for("yaml.pair"), ee = Symbol.for("yaml.scalar"), Ne = Symbol.for("yaml.seq"), G = Symbol.for("yaml.node.type"), H = (t) => !!t && typeof t == "object" && t[G] === wn, ne = (t) => !!t && typeof t == "object" && t[G] === bn, U = (t) => !!t && typeof t == "object" && t[G] === oe, T = (t) => !!t && typeof t == "object" && t[G] === bs, C = (t) => !!t && typeof t == "object" && t[G] === ee, J = (t) => !!t && typeof t == "object" && t[G] === Ne;
	kn = (t) => (C(t) || I(t)) && !!t.anchor;
	W = Symbol("break visit"), ni = Symbol("skip children"), me = Symbol("remove node");
	ae.BREAK = W;
	ae.SKIP = ni;
	ae.REMOVE = me;
	Lt.BREAK = W;
	...
	ma = {
		...
		"{": "%7B",
		"}": "%7D"
	}, ha = (t) => t.replace(/[!,[\]{}]/g, (e) => ma[e]), he = class t {
		constructor(e, n) {
...
`);
	...
	Cn = (t) => !t || typeof t != "function" && typeof t != "object", y = class extends xe {
		constructor(e) {
	...
	nt = (t) => t == null || typeof t == "object" && !!t[Symbol.iterator]().next().done, tt = class extends xe {
		constructor(e, n) {
...
|$)`, "g");
	...
	Rn = (t) => typeof t == "bigint" || Number.isInteger(t), Os = (t, e, n, { intAsBigInt: s }) => s ? BigInt(t) : parseInt(t.substring(e), n);
	qn = {
		identify: (t) => Rn(t) && t >= 0,
		default: !0,
	...
	Yn = ({ value: t }) => JSON.stringify(t), Na = [
		{
			identify: (t) => typeof t == "string",
			default: !0,
			tag: "tag:yaml.org,2002:str",
...
` : " ");
	...
	Ta = (t, e) => t.key < e.key ? -1 : t.key > e.key ? 1 : 0, lt = class t {
...
`;
	...
	Ms = "Block collections are not allowed within flow collections", $s = (t) => t && (t.type === "block-map" || t.type === "block-seq");
	Da = {
		0: "\0",
		a: "\x07",
		b: "\b",
...
${n.comment}` : n.comment;
	...
	Ks = Symbol("break visit"), Fa = Symbol("skip children"), Ui = Symbol("remove item");
	Re.BREAK = Ks;
	Re.SKIP = Fa;
	Re.REMOVE = Ui;
	Re.itemAtPath = (t, e) => {
	...
	jt = "﻿", Vt = "", Gt = "", pt = "", Ka = (t) => !!t && "items" in t, Ya = (t) => !!t && (t.type === "scalar" || t.type === "single-quoted-scalar" || t.type === "double-quoted-scalar" || t.type === "block-scalar");
	Vi = /* @__PURE__ */ new Set("0123456789ABCDEFabcdef"), ja = /* @__PURE__ */ new Set("0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz-#;/?:@&=+$_.!~*'()"), Zn = /* @__PURE__ */ new Set(",[]{}"), Va = /* @__PURE__ */ new Set(` ,[]{}
\r	`), js = (t) => !t || Va.has(t), mt = class {
		constructor() {
