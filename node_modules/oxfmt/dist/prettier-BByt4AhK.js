...
async function loadYaml(file) {
	const content = await read_file_default(file);
	if (!parseYaml) ({__parsePrettierYamlConfig: parseYaml} = await import("./yaml-DlyuuZmC.js"));
	try {
...
var init_prettier = __esmMin((() => {
	...
	init_production_plugins = __esm({ "src/main/plugins/builtin-plugins/production-plugins.js"() {
		...
		plugins = /* @__PURE__ */ toLazyLoadPlugins({
			name: "acorn",
			load: () => import("./acorn-CZllRq2x.js"),
			parsers: ["acorn", "espree"]
		}, {
			name: "angular",
			load: () => import("./angular-CsoDKqo4.js"),
			parsers: [
				"__ng_action",
				"__ng_binding",
				"__ng_directive",
			...
			name: "markdown",
			load: () => import("./markdown-BjyDFyaO.js"),
			...
			name: "meriyah",
			load: () => import("./meriyah-zDNCk2o1.js"),
			parsers: ["meriyah"]
		}, {
			name: "postcss",
			load: () => import("./postcss-CwPwODg8.js"),
			...
			name: "typescript",
			load: () => import("./typescript-Bq_S3kyC.js"),
			parsers: ["typescript"]
		}, {
			name: "yaml",
			load: () => import("./yaml-DlyuuZmC.js"),
