...
__esmMin((() => {
	...
	ic = 5, sc = 8, uc = 8, ji = (e) => (t) => t.label ? S(t.label) : b(t) + e, ac = (e) => e.__contentEnd ?? It(e), vi = [
		"ExpressionStatement",
		"Directive",
		"ImportDeclaration",
	...
	de = B([
		...
		"AsConstExpression",
		"SatisfiesExpression"
	]), Gi = B(["SatisfiesExpression", "TSSatisfiesExpression"]), pe = B(["TSUnionType", "UnionTypeAnnotation"]), At = B(["TSIntersectionType", "IntersectionTypeAnnotation"]), Zt = B(["TupleTypeAnnotation", "TSTupleType"]), $e = B(["TSConditionalType", "ConditionalTypeAnnotation"]), Vr = B(["TSTypeAliasDeclaration", "TypeAlias"]), ut = B(["ReturnStatement", "ThrowStatement"]), Ui = B([
		"ExportDefaultDeclaration",
		"DeclareExportDeclaration",
		"ExportNamedDeclaration",
		"ExportAllDeclaration",
		"DeclareExportAllDeclaration"
	]), Y = B(["ArrayExpression"]), ie = B(["ObjectExpression"]), er = B([
		"Literal",
		"BooleanLiteral",
		"BigIntLiteral",
		"DirectiveLiteral",
		...
		"TSTypeLiteral",
		"TSMappedType"
	]), wt = B(["FunctionExpression", "ArrowFunctionExpression"]), H = B(["JSXElement", "JSXFragment"]), Be = B([
		"BinaryExpression",
		"LogicalExpression",
		"NGPipeExpression"
	]), M = B(["CallExpression", "OptionalCallExpression"]), N = B(["MemberExpression", "OptionalMemberExpression"]), Tt = B([
		"CallExpression",
...
` || e === "\r" || e === "\u2028" || e === "\u2029";
	...
	go = (e, t) => le(e) && !te(t, b(e), S(e)), wr = (e, t) => qe(e) || go(e, t);
	Wc = B([
		"ClassDeclaration",
		"ClassExpression",
		"DeclareClass",
	...
	Ts = (e) => e.extra?.parenthesized, cl = B(["OptionalCallExpression", "OptionalMemberExpression"]);
	nn = ml;
	Or = null;
	yl = 10;
	...
	ne = ks;
	ze = "string", Oe = "array", ct = "cursor", Ze = "indent", et = "align", lt = "trim", Te = "group", Je = "fill", Me = "if-break", tt = "indent-if-break", rt = "line-suffix", Ye = "line-suffix-boundary", Fe = "line", _e = "label", Ge = "break-parent", pn = /* @__PURE__ */ new Set([
		ct,
		Ze,
		et,
		lt,
...
`;
	...
	ql = /^(?:[\xA9\xAE\u203C\u2049\u2122\u2139\u2194-\u2199\u21A9\u21AA\u2328\u23CF\u23ED-\u23EF\u23F1\u23F2\u23F8-\u23FA\u24C2\u25AA\u25AB\u25B6\u25C0\u25FB\u25FC\u2600-\u2604\u260E\u2611\u2618\u2620\u2622\u2623\u2626\u262A\u262E\u262F\u2638-\u263A\u2640\u2642\u265F\u2660\u2663\u2665\u2666\u2668\u267B\u267E\u2692\u2694-\u2697\u2699\u269B\u269C\u26A0\u26A7\u26B0\u26B1\u26C8\u26CF\u26D1\u26D3\u26E9\u26F0\u26F1\u26F4\u26F7\u26F8\u2702\u2708\u2709\u270F\u2712\u2714\u2716\u271D\u2721\u2733\u2734\u2744\u2747\u2763\u2764\u27A1\u2934\u2935\u2B05-\u2B07]|\uD83C[\uDD70\uDD71\uDD7E\uDD7F\uDF21\uDF24-\uDF2C\uDF36\uDF7D\uDF96\uDF97\uDF99-\uDF9B\uDF9E\uDF9F\uDFCD\uDFCE\uDFD4-\uDFDF\uDFF3\uDFF5\uDFF7]|\uD83D[\uDC3F\uDC41\uDCFD\uDD49\uDD4A\uDD6F\uDD70\uDD73\uDD76-\uDD79\uDD87\uDD8A-\uDD8D\uDDA5\uDDA8\uDDB1\uDDB2\uDDBC\uDDC2-\uDDC4\uDDD1-\uDDD3\uDDDC-\uDDDE\uDDE1\uDDE3\uDDE8\uDDEF\uDDF3\uDDFA\uDECB\uDECD-\uDECF\uDEE0-\uDEE5\uDEE9\uDEF0\uDEF3])$/, $s = (e) => ql.test(e);
	Yl = /[^\x20-\x7F]/;
	dt = Hl;
	Xl = { type: 0 }, Vl = { type: 1 }, Ro = {
		value: "",
		length: 0,
		queue: [],
		get root() {
	...
	nt = Symbol("MODE_BREAK"), Ct = Symbol("MODE_FLAT"), Jo = Symbol("DOC_FILL_PRINTED_LENGTH");
	...
	lu = xm;
	ot = Am;
	mu = (e) => e.type === "TSEnumMember", fu = (e) => mu(e) ? "id" : "key", vr = (e) => e[fu(e)], Du = (e) => !mu(e) && e.computed;
	...
	ri = 0;
	Mu = Lu.bind(void 0, "html"), _u = Lu.bind(void 0, "angular");
	Km = [
		{
			test: Iu,
			print: Pu
...
\r	`);
	...
	Wa = (e, t, r) => Ft(e, t, r, "consequent"), Ja = (e, t, r) => Ft(e, t, r, "alternate");
	pD = B([
		"TSAsExpression",
		"TSTypeAssertion",
		"TSNonNullExpression",
