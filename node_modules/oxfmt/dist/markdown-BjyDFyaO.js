...
__esmMin((() => {
	...
	hm = Object.getPrototypeOf, mm = Object.prototype.hasOwnProperty;
	q = (e, t) => () => {
		try {
...
`, NF = 2;
	...
	pt = (e) => e.position.start.offset, ht = (e) => e.position.end.offset;
	gm = {};
	Wn = {
		AElig: "Æ",
		AMP: "&",
...
`,
	...
	km = {}.hasOwnProperty;
	Eu = {}.hasOwnProperty;
	K = rt(/[A-Za-z]/), Q = rt(/[\dA-Za-z]/), wu = rt(/[#-'*+\--9=?A-Z^-~]/);
	tr = rt(/\d/), Cu = rt(/[\dA-Fa-f]/), yu = rt(/[!-/:-@[-`{-~]/);
	Dt = rt(/\p{P}|\p{S}/u), Ie = rt(/\s/);
	vu = { tokenize: Em };
	Tu = { tokenize: wm }, Au = { tokenize: Cm };
	rr = {
		name: "attention",
		resolveAll: ym,
		tokenize: vm
	...
	gt = {
		...
		resolveTo: cD,
		tokenize: fD
	}, uD = { tokenize: pD }, oD = { tokenize: hD }, sD = { tokenize: mD };
	ri = {
	...
	qu = { tokenize: TD };
	Bu = { resolveAll: Nu() }, _u = Ou("string"), Pu = Ou("text");
	ii = {};
	Or(ii, {
		attentionMarkers: () => ND,
		contentInitial: () => ID,
	...
	LD = {
		...
		95: rr,
		96: $n
	}, OD = { null: [rr, Bu] }, ND = { null: [42, 95] }, RD = { null: [] };
	Mu = /[\0\t\n\r]/g;
	...
	sr = "liquidNode";
	hh = At(wo(), 1), mh = At(No(), 1), Dh = At(Bf(), 1), dh = At(vp(), 1);
	Lb = /^import\s/, Ib = /^export\s/, Ap = "[a-z][a-z0-9]*(\\.[a-z][a-z0-9]*)*|", Tp = /<!---->|<!---?[^>-](?:-?[^-])*-->/, qb = /^\{\s*\/\*(.*)\*\/\s*\}/;
	Bb = (e) => Lb.test(e), Sp = (e) => Ib.test(e), Lp = (e) => Bb(e) || Sp(e), Ua = (e, t) => {
		let r = t.indexOf(`
...
`), n = r === -1 ? t : t.slice(0, r);
	...
	De = "string", de = "array", st = "cursor", Ae = "indent", Te = "align", $e = "trim", ke = "group", Fe = "fill", be = "if-break", Ke = "indent-if-break", Qe = "line-suffix", Je = "line-suffix-boundary", ge = "line", Xe = "label", Se = "break-parent", Tn = /* @__PURE__ */ new Set([
		st,
		Ae,
		Te,
		$e,
...
`;
	...
	Kb = /^(?:[\xA9\xAE\u203C\u2049\u2122\u2139\u2194-\u2199\u21A9\u21AA\u2328\u23CF\u23ED-\u23EF\u23F1\u23F2\u23F8-\u23FA\u24C2\u25AA\u25AB\u25B6\u25C0\u25FB\u25FC\u2600-\u2604\u260E\u2611\u2618\u2620\u2622\u2623\u2626\u262A\u262E\u262F\u2638-\u263A\u2640\u2642\u265F\u2660\u2663\u2665\u2666\u2668\u267B\u267E\u2692\u2694-\u2697\u2699\u269B\u269C\u26A0\u26A7\u26B0\u26B1\u26C8\u26CF\u26D1\u26D3\u26E9\u26F0\u26F1\u26F4\u26F7\u26F8\u2702\u2708\u2709\u270F\u2712\u2714\u2716\u271D\u2721\u2733\u2734\u2744\u2747\u2763\u2764\u27A1\u2934\u2935\u2B05-\u2B07]|\uD83C[\uDD70\uDD71\uDD7E\uDD7F\uDF21\uDF24-\uDF2C\uDF36\uDF7D\uDF96\uDF97\uDF99-\uDF9B\uDF9E\uDF9F\uDFCD\uDFCE\uDFD4-\uDFDF\uDFF3\uDFF5\uDFF7]|\uD83D[\uDC3F\uDC41\uDCFD\uDD49\uDD4A\uDD6F\uDD70\uDD73\uDD76-\uDD79\uDD87\uDD8A-\uDD8D\uDDA5\uDDA8\uDDB1\uDDB2\uDDBC\uDDC2-\uDDC4\uDDD1-\uDDD3\uDDDC-\uDDDE\uDDE1\uDDE3\uDDE8\uDDEF\uDDF3\uDDFA\uDECB\uDECD-\uDECF\uDEE0-\uDEE5\uDEE9\uDEF0\uDEF3])$/, Kp = (e) => Kb.test(e);
	Qb = /[^\x20-\x7F]/;
	Tr = Jb;
	Xb = { type: 0 }, Zb = { type: 1 }, Ya = {
		value: "",
		length: 0,
		queue: [],
		get root() {
	...
	Ce = Symbol("MODE_BREAK"), Re = Symbol("MODE_FLAT"), Ka = Symbol("DOC_FILL_PRINTED_LENGTH");
	...
	iE = nE();
	nh = (e) => String(e).split(/[/\\]/).pop(), ih = (e) => String(e).startsWith("file:");
	sE = void 0;
	Ja = lE;
	Xa = cE;
	fE = function() {
	...
	Za = /* @__PURE__ */ new Set([
		...
		"paragraph",
		"heading"
	]), Kt = "non-cjk", Me = "cj-letter", Ct = "k-letter", Sr = "cjk-punctuation", pE = /\p{Script_Extensions=Hangul}/u;
...
`;
	...
	Rn = (e) => Ge(e).content.trimStart().match(kh)?.index === 0, Fh = (e) => Ge(e).content.trimStart().match(xh)?.index === 0, bh = (e) => {
